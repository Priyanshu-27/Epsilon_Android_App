...
import { Store_S_ID } from '../services/Asyncstorage'

const HelpForStudent = () => {
    ...
    return (
        <View>
            ...
            <View style={{ marginTop: 40 }}>
                ...
                <TouchableRipple onPress={() => {navigation.navigate("GuidelinesforStudent")}}>
                    <View style={styles.menuItem}>
