...
const EditProfileScreenForTeacher = ({navigation:{goback}}) => {
  ...
  const handleSubmitButton = () => {
     ...
     fetch(`http://10.0.2.2:8000/${JSON.parse(T_id)}/Teacher_Profile_edit`, {
    method: 'POST',
...
export default EditProfileScreenForTeacher